...
class OstAddSessionWithQR extends OstAddSession {
    ...
    static class AddSessionDataDefinitionInstance extends OstDeviceDataDefinitionInstance {
        ...
        public AddSessionDataDefinitionInstance(JSONObject dataObject, String qrVersion, String userId, OstWorkFlowCallback callback) {
            super(dataObject, userId, callback);
            this.qrVersion = qrVersion;
        }

        public static AddSessionDataDefinitionInstance fromV2QR(String v2QrString, String userId, OstWorkFlowCallback callback ) {
            ...
            return new AddSessionDataDefinitionInstance(dataObject, version, userId, callback);
        }
...
//            }
        ...
        @Nullable String getDataDefination() {
