...
public class OstC1Label extends OstTextView {
    public OstC1Label(Context context) {
        super(context);
    }

    public OstC1Label(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public OstC1Label(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    void defineUi(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        ThemeConfig.getInstance().C1().apply(this);
    }
}
