...
public class OstB4Label extends OstButton {
    public OstB4Label(Context context) {
        super(context);
    }

    public OstB4Label(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public OstB4Label(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    void defineUi(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        ThemeConfig.getInstance().B4().apply(this);
    }
}
