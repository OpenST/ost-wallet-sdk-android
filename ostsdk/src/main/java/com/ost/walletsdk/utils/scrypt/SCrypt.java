 ...
 *  Change description:
 *    1. Use pure java implementation of SCrypt.
 *    2. Add clearBytes method to safely clear byte[].
 *    3. Wipe out byte[] after use.
 *      - Note: input are not wiped. Only byte[] created inside this code are wiped.
 * */

package com.ost.walletsdk.utils.scrypt;
...
*/
    ...
    */
    ...
    /**
     * A private method to safely clear byte[].
     * @param secret
     */
