...
public class OstB1Label extends OstButton {
    public OstB1Label(Context context) {
        super(context);
    }

    public OstB1Label(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public OstB1Label(Context context, AttributeSet attrs, int defStyleAttr) {
