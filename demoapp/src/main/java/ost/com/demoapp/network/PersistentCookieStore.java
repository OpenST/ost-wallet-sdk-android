...
public class PersistentCookieStore implements java.net.CookieStore {
    private static final String TAG = PersistentCookieStore.class
            .getSimpleName();

    // Persistence
    private static final String SP_COOKIE_STORE = "PEPO_COOKIE_STORE";
    ...
    private void loadAllFromPersistence() {
        ...
        for (Map.Entry<String, ?> entry : allPairs.entrySet()) {
            ...
            try {
                ...
                Log.d("ENCODED COOKIE", encodedCookie);
    ...
    private static URI cookieUri(URI uri, HttpCookie cookie) {
        ...
        if (cookie.getDomain() != null) {
            // Remove the starting dot character of the domain,
            // if exists (e.g: .domain.com -> domain.com)
